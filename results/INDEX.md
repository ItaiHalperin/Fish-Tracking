...
|---|---|---|---|---|---|---|
| yolo_n_default_20260624_151209 | yolo11n-cls (YOLO baseline) | ultralytics defaults (randaugment), no flip | 1521 / 363 / 266 | 60.53% | 0.516 | Off-the-shelf YOLO baseline (our test harness; train 85 / val 82). Likely a lowball: default randaugment corrupts direction labels, and ultralytics' internal val metric was unreliable (drove checkpoint choice). |
